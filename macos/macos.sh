...
# Set hostname
sudo scutil --set ComputerName "pb"
sudo scutil --set HostName "pb"
sudo scutil --set LocalHostName "pb"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "pb"
